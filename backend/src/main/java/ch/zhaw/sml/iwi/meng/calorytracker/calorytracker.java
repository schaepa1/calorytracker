...
public class calorytracker implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        user1.setUserWeightGainCalories(2500);
        user1.setUserWeightKeepCalories(2000);
        user1.setUserWeightLoseCalories(1600);
        ...
        user2.setUserWeightGainCalories(2500);
        user2.setUserWeightKeepCalories(2000);
        user2.setUserWeightLoseCalories(1600);
        ...
        product1.setProductConsumeDate("06.07.2022");
